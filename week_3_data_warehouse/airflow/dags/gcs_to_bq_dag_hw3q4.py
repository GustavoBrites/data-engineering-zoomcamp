...
DATASET = "tripdata"
COLOUR_RANGE = {'fhv': 'dropoff_datetime'} #'yellow': 'tpep_pickup_datetime','fhv': 'DropOff_datetime'
INPUT_PART = "ingested"
...
with DAG(
    ...
    for colour, ds_col in COLOUR_RANGE.items():
        ...
        # Query Q4
        CREATE_BQ_TBL_QUERY = (
            f"CREATE OR REPLACE TABLE {BIGQUERY_DATASET}.{colour}_{DATASET}_partitioned_clustered2 \
            PARTITION BY DATE({ds_col}) \
